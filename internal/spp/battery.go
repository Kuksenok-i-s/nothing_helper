...
var commandCatalog = map[uint16]CommandInfo{
	CmdGetSuperMic:         {Name: "get_super_mic", Kind: "query"},
	CmdGetWalkieTalkie:     {Name: "get_walkie_talkie", Kind: "query"},
	CmdSetSuperMic:         {Name: "set_super_mic", Kind: "set", Safe: true},
	CmdSetWalkieTalkie:     {Name: "set_walkie_talkie", Kind: "set", Safe: true},
	CmdRspSuperMic:         {Name: "rsp_super_mic", Kind: "binary"},
	CmdRspWalkieTalkie:     {Name: "rsp_walkie_talkie", Kind: "binary"},
	CmdWalkieTalkieChanged: {Name: "event_walkie_talkie_changed", Kind: "notification"},
	...
	0xF002: {Name: "set_where_am_i", Kind: "set", Safe: true},
